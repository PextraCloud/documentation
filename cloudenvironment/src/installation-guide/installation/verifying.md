...
### SHA256 Checksum
1. Download the SHA256 checksum file (the file that ends with `.sha256`) from the Pextra Customer Portal.
...
1. Download the GPG signature file (the file that ends with `.sha256.asc`) from the Pextra Customer Portal.
...
1. Download the GPG signature file (the file that ends with `.iso.asc`) from the Pextra Customer Portal.
...
2. Download the GPG signature file (the file that ends with `.sha256.asc`) from the Pextra Customer Portal.
