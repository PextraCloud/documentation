...
![Review Role Summary](./images/role-create-5.png)

8. The newly created role will appear in the **Roles** list.

![Roles List](./images/role-create-6.png)
