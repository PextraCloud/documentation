# Feature Gating
The following feature flags currently require the **Enterprise** edition (or higher):

| Feature Flag | Description |
| --- | --- |
| `IAM_ABAC_RULES` | Enables dynamic ABAC expressions inside IAM policy statements. |
