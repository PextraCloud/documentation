...
>[!NOTE]
>You must have the `tag.list` permission on the resource in order to view tags.

## Resource Tree
Tags appear next to the resource name in the resource tree:
![Resource Tree with Tags](./images/tags-view-0.png)

## Dropdowns & Selectors
Tags also appear in any dropdown that lists the resource:
![Dropdown with Tags](./images/tags-view-1.png)