...
- [Node Management](./user-guide/nodes/index.md)
  ...
  - [Manage Instance Images](./user-guide/nodes/instance-images/index.md)
    - [Import from Docker/Podman Registry](./user-guide/nodes/instance-images/docker-registry.md)
    - [Import from File](./user-guide/nodes/instance-images/file.md)
    - [Import from ImageHub™](./user-guide/nodes/instance-images/imagehub.md)
